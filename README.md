...
git clone https://github.com/alarrab2/arrabapi
...
git clone https://github.com/alarrab2/arrabapi && cd ararrab& chmod +x install.sh && ./install.sh
...
cd * && tmux new-session -s 0 bash arrab-Auto.sh
